...
pv.out = pathview(gene.data = swt_l2fc, gene.idtype = "ENSEMBL", pathway.id = "04916", species = "dre", out.suffix = "SWT", kegg.native = T, split.group = F, expand.node = F, low = "dodgerblue2", mid = "gray", high = "firebrick2")
...
pv.out = pathview(gene.data = mwt_l2fc, gene.idtype = "ENSEMBL", pathway.id = "04260", species = "dre", out.suffix = "MWT", kegg.native = T, split.group = F, expand.node = F, low = "dodgerblue2", mid = "gray", high = "firebrick2")
